...
return!0;var item=key.toLowerCase(),source,text;switch(item){case 'facebook':source="https://web.archive.org/web/20180822162540/http://www.facebook.com/share.php?v=4&src=bm&u={URL}",text="Share on Facebook";break;case 'twitter':source="https://web.archive.org/web/20180822162540/http://twitter.com/home?status={URL}",text="Share on Twitter";break;case 'googleplus':source="https://web.archive.org/web/20180822162540/https://plus.google.com/share?url={URL}",text="Share on Google+";break;case 'delicious':source="https://web.archive.org/web/20180822162540/http://delicious.com/post?url={URL}",text="Share on Delicious";break;case 'digg':source="https://web.archive.org/web/20180822162540/http://digg.com/submit?phase=2&url={URL}",text="Share on Digg";break;case 'reddit':source="https://web.archive.org/web/20180822162540/http://reddit.com/submit?url={URL}",text="Share on reddit";break}
...
function doAjax(url,callback){var url="//web.archive.org/web/20180822162540/http://ilightbox.net/getSource/jsonp.php?url="+encodeURIComponent(url).replace(/!/g,'%21').replace(/'/g,'%27').replace(/\(/g,'%28').replace(/\)/g,'%29').replace(/\*/g,'%2A');$.ajax({url:url,dataType:'jsonp'});iLCallback=function(data){callback.call(this,data)}}
...
return _QTComplain(a,gArgCountErr),"";gTagAttrs=[];gTagAttrs.src=c[0];gTagAttrs.width=c[1];gTagAttrs.height=c[2];gTagAttrs.classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B";gTagAttrs.pluginspage="https://web.archive.org/web/20180822162540/http://www.apple.com/quicktime/download/";a=c[3];if(null==a||""==a)
a="6,0,2,0";gTagAttrs.codebase="https://web.archive.org/web/20180822162540/http://www.apple.com/qtactivex/qtplugin.cab#version="+a;for(var d,e=4;e<c.length;e+=2)
...
/*
     FILE ARCHIVED ON 16:25:40 Aug 22, 2018 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.017
  cdx.remote: 7.273
  LoadShardBlock: 205.928 (3)
  PetaboxLoader3.datanode: 191.198 (6)
  PetaboxLoader3.resolve: 128.237 (2)
  load_resource: 161.88
*/