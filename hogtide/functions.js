...
//			jQuery('.blog-items:not(.carousel-items),article.type-portfolio,article.type-post,article.type-team,.spb_video_widget,.infocus-item,.full-width-detail,#activity-stream').fitVids({ ignore: '.no-fv'});
		...
		articleShare: function() {
			jQuery('.article-share').each(function() {
				...
				links += '<li class="pinterest enabled" data-network="pinterest"><a href="https://web.archive.org/web/20180822153928/http://pinterest.com/pin/create/button/?url=' + permalink + '&media=' + image + '&description=' + title + '" onclick="javascript:window.open(this.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=690,width=750\');return false;"></a></li>';
				links += '<li class="twitter enabled" data-network="twitter"><a href="https://web.archive.org/web/20180822153928/http://twitter.com/share?text=' + title + '&url=' + permalink + '" onclick="javascript:window.open(this.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=440,width=660\');return false;"></a></li>';
				links += '<li class="facebook enabled" data-network="facebook"><a href="https://web.archive.org/web/20180822153928/https://www.facebook.com/sharer/sharer.php?u=' + permalink + '" onclick="javascript:window.open(this.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=440,width=660\');return false;"></a></li>';
				if ( isMobile ) {
				links += '<li class="whatsapp enabled" data-network="whatsapp"><a href="whatsapp://send?text=' + title + ' ' + permalink + '"></a></li>';
				}
				links += '<li class="googlePlus enabled" data-network="googlePlus"><a href="https://web.archive.org/web/20180822153928/https://plus.google.com/share?url=' + permalink + '" onclick="javascript:window.open(this.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=440,width=660\');return false;"></a></li>';
				//links += '<li class="reddit enabled" data-network="reddit"><a onclick="return false"></a></li>';
				links += '<li class="linkedin enabled" data-network="linkedin"><a href="https://web.archive.org/web/20180822153928/https://www.linkedin.com/shareArticle?mini=true&url=' + permalink + '&title=' + title + '" onclick="javascript:window.open(this.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=690,width=750\');return false;"></a></li>';
		...
		lightbox: function() {
			...
			if (lightboxSharing) {
				lightboxSocial = {
					facebook: {
						source: 'https://web.archive.org/web/20180822153928/https://www.facebook.com/sharer/sharer.php?u={URL}',
						text: 'Share on Facebook'
					},
					twitter: true,
					googleplus: true,
					pinterest: {
						source: "https://web.archive.org/web/20180822153928/https://pinterest.com/pin/create/button/?url={URL}&media={URL}",
		...
		mainMenuActions: function() {
			...
			jQuery('.menu-item').on('click', 'a', function(e) {
				...
				if (youtubeURL || vimeoURL) {
					...
					if (youtubeURL) {
						videoURL = 'https://web.archive.org/web/20180822153928/http://www.youtube.com/embed/'+ youtubeURL[1] +'?autoplay=1&amp;wmode=transparent';
					} else if (vimeoURL) {
						videoURL = 'https://web.archive.org/web/20180822153928/https://player.vimeo.com/video/'+ vimeoURL[3] +'?title=0&amp;byline=0&amp;portrait=0&amp;autoplay=1&amp;wmode=transparent';
					}
	...
	SWIFT.blog = {
		...
		masonryInstagram: function(instagrams, blogItems) {
			...
			jQuery.ajax({
				...
				url: 'https://web.archive.org/web/20180822153928/https://api.instagram.com/v1/users/' + userID + '/media/recent?access_token=' + token,
		...
		blogGridInstagram: function(instagrams, gridItems) {
			...
			jQuery.ajax({
				url: 'https://web.archive.org/web/20180822153928/https://api.instagram.com/v1/users/' + userID + '/media/recent?access_token=' + token, // specify the ID of the first found user
				dataType: 'jsonp',
				type: 'GET',
				data: {client_id: clientid, count: count},
				success: function(data) {
...
/*
     FILE ARCHIVED ON 15:39:28 Aug 22, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 01:13:35 Feb 06, 2025.
...
playback timings (ms):
  ...
  PetaboxLoader3.datanode: 172.457 (6)
  load_resource: 63.156
*/